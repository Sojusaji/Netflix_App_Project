    ...
    return _then(_value.copyWith(
      ...
      title: title == freezed
          ...
          : title // ignore: cast_nullable_to_non_nullable
              as String?,
      backdroPath: backdroPath == freezed
          ? _value.backdroPath
...
class _$_Downloads implements _Downloads {
  const _$_Downloads(
      ...
      @JsonKey(name: 'backdrop_path') required this.backdroPath});
  ...
  @override
  String toString() {
    return 'Downloads(posterPath: $posterPath, title: $title, backdroPath: $backdroPath)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.backdroPath, backdroPath));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(backdroPath));
...
abstract class _Downloads implements Downloads {
  const factory _Downloads(
          ...
          @JsonKey(name: 'backdrop_path') required final String? backdroPath}) =
      _$_Downloads;
